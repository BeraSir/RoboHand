...
This is the basic finger assembly. Each join has a tortion spring and 3mm wire to hold it together. Parts are 3D printed from PETG and post-proccessed with sandpaper.

### Tendon System
![Tendon_System](RoboHand_Images/Tendon_System_1_0.jpg)
Each finger is powered by a tendon system. Fishing line is routed up, and is powered by a motor with a spool on it. 9g servos with a 360 degree freedom mod are used.
